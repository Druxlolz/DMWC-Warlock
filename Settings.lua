...
function Warlock.Settings()
    ...
    UI.AddRange("Auto Pull Min Health", "Amount of Health in % before pulling with AutoTarget Quest", 0, 100, 1, 25)
    UI.AddRange("Auto Pull Min Mana", "Amount of Mana in % before pulling with AutoTarget Quest", 0, 100, 1, 25)
    UI.AddHeader("DPS")
